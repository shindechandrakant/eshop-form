...
interface SimpleArrayFormProps {
  items: SimpleItem[];
...
export const SimpleArrayForm: React.FC<SimpleArrayFormProps> = ({ 
  items, 
  onChange, 
  title, 
  singular 
  ...
  const updateItem = (index: number, field: keyof SimpleItem, value: string) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                placeholder={`${singular.toLowerCase()}_id`}
              />
            </div>
