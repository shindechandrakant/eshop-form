...
import { Country } from "../types/Cashback";

interface CountryFormCashbackProps {
  countries: Country[];
...
export const CountryFormCashback: React.FC<CountryFormCashbackProps> = ({
  countries,
  onChange,
}) => {
  const addCountry = () => {
      ...
      {countries.map((country, index) => (
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-2">ISO Code</label>
              <input
                type="text"
